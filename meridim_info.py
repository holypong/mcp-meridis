...
class MeridimKeyParams:
    ...
    L_FOOT_Y_CMD: int = key_field(48, "左足Y位置（追加サーボ用のコマンドを流用・mcp-meridis/redis_plotterで使用）")
    ...
    R_FOOT_Y_CMD: int = key_field(78, "右足Y位置（追加テスト用のコマンドを流用・mcp-meridis/redis_plotterで使用）")
